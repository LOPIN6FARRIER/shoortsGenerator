...
export const SPANISH_CHANNEL: ChannelIdentity = {
  visual: {
    ...
    fontSize: 36, // Reducido al mínimo para evitar cortes
    subtitleStyle: {
      fontWeight: "bold",
      strokeColor: "#000000",
      strokeWidth: 3,
  ...
  subtitles: {
    maxLines: 2,
    maxCharsPerLine: 12, // Ultra-ultra conservador para evitar cualquier corte
...
export const ENGLISH_CHANNEL: ChannelIdentity = {
  ...
  subtitles: {
    maxLines: 2,
    maxCharsPerLine: 11, // Ultra-ultra conservador para evitar cualquier corte
